...
1. **Update System:** NVIDIA driver build fails (See Issue #489947).
2. **Panic:** You don't read the logs. You don't check the overlay. You hyperventilate.
3. **Rage:** You blame the distro maintainers because you're too incompetent to understand kernel patching.
4. **The Walk of Shame:** You reboot into your Windows dual-boot to play your spyware shooter like the little traitor you are.
...
1. You saw a top post on r/unixporn.
2. You went to the GitHub repo.
3. You clicked the green **"Code > Download ZIP"** button.
4. You right-clicked and selected **"Extract with WinRAR"** because you're still dual-booting like a coward.
